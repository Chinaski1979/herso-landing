...
link: https://tabstr.net/
image:
    source: "@assets/images/projects/tabstr.png"
    alt: "Screenshot of Tabstr tab management platform"
---
...
Key features:
- Runs in any device and any operating system
- Offline support for when the internet is not available
- Connection with Costa Rica's Hacineda electronic invoices
- Open and manage tabs from any device
- Real-time updates for staff and customers
- Integration with popular ordering apps
